...
class SS_Conv_SSM(nn.Module):
    ...
    def forward(self, input: torch.Tensor):
        ...
        output = output + residual  #residual connections
...
class VSSM(nn.Module):
    ...
    def __init__(self,hidden_dim=4, patch_size=4, in_chans=1, num_classes=1000, depths=[2, 2, 4, 2], depths_decoder=[2, 9, 2, 2],
