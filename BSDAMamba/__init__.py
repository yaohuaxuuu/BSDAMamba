...
def get_model(model_name: str, isda: bool, brsda: bool,  data_info: dict, random_noise:bool = False):
    ...
    elif 'MedMamba' == model_name:
        model = get_medmamba(data_info['n_channels'],data_info['n_classes'])
    else:
...
def get_medmamba(in_channel,num_classes):
    model = medmamba(in_channel=in_channel, num_classes=num_classes)
    return model 
